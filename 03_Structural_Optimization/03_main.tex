...
\label{ch:struct_opt}
    ...
    \label{sec:eos}
        ...
        \Paragraph{Calculation Details} }The standard self-consistent calculator as outlined in \textbf{MAKE CALCULATOR SECTION} is employed for all self-consistent calculations. 
